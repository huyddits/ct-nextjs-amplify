...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CapacitorCommunitySafeArea/CapacitorCommunitySafeArea.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CapacitorCordova/Cordova.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CapacitorPluginSafeArea/CapacitorPluginSafeArea.framework"
fi
