    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="pt-4 pb-[80px] max-w-3xl mx-auto p-4">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm mb-4">
          <h1 className="text-2xl font-bold text-[#257951] mb-6">About Cheer Trainer</h1>
          ...
          <div className="space-y-6">
            ...
            <section>
              ...
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-[#257951]">
            ...
            <section>
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  <Mail className="h-5 w-5 text-[#257951] mr-3" />
                  <span className="text-gray-600">info@cheertrainer.com</span>
                </div>
                <div className="flex items-center">
                  <Phone className="h-5 w-5 text-[#257951] mr-3" />
                  <span className="text-gray-600">(555) 123-4567</span>
                </div>
              </div>
              <div className="flex space-x-4 mt-4">
                <a href="#" className="text-[#257951] hover:text-[#1a5a3a] transition-colors">
