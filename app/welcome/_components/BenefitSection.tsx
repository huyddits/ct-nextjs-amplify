import { AwardIcon, BarChartIcon, UsersIcon, ShieldIcon, CheckCircleIcon } from 'lucide-react';
import BenefitCard from './BenefitCard';
export default function BenefitSection() {
  const listItems = [
    {
      title: 'Elevate Your Performance',
      content: 'Develop the specific strength needed to advance your stunting and tumbling',
    ...
    },
    {
      ...
      content: 'Access training plans designed specifically for cheerleading skills',
      icon: <AwardIcon className="h-8 w-8 text-primary" />,
    },
    {
